...
export const PricingItemsService = {
     ...
     * If updating Bolts & Nuts (Sr=21), triggers recalculation of all accessories
    ...
    async updateItem(id, data) {
        ...
        console.log(`   Is Bolts & Nuts (Sr=21): ${isBoltsAndNuts}`);

        console.log(`   Is Motor Price Trigger (Sr=20 or 22): ${isMotorPriceTrigger}`);
        ...
        if (isBoltsAndNuts && data.priceWithVat !== undefined) {
            ...
            console.log(`🔄 BOLTS & NUTS (Sr=21) UPDATE DETECTED!`);
        ...
        // If this is Electrical Cables (Sr=18), recalculate all cable prices
        ...
        // If this is sr=18 or sr=19, also recalculate all electrical prices (Flex Connector, Gland, Brass Bar, Elec Box, Total)
